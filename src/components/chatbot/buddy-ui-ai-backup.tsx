    ...
    >
      ...
      <Container
        ...
        className={cn(
          ...
          {
            [`h-[calc(100dvh-${keyboardHeight}vh)] overflow-hidden`]: isHome,
      ...
      >
        ...
        <div
          className={cn('flex flex-col', {
            ...
            'h-[100dvh]': isHome && !isMobile && messages.current.length > 0,
          })}
        >
          ...
          <div
            className={cn(
              'fixed flex flex-col max-h-[30vh] mb-60 overflow-y-auto overscroll-none transition-all',
              {
                ...
                hidden: !isHome,
                'min-h-[calc(100dvh-250px)]': messages.current.length > 0,
